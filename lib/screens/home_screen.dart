...
class HomeScreen extends StatefulWidget {
  final String userId; // Nhận userId từ MainScreen
  final double temperature; // Nhận temperature từ MainScreen
  final double humidity; // Nhận humidity từ MainScreen
  final double light; // Nhận light từ MainScreen
  final bool isLoading; // Nhận trạng thái isLoading từ MainScreen
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildControlRow(
                        'Ánh sáng',
                        '${widget.light.toStringAsFixed(0)} lux',
                        isLightSensorEnabled,
                        Icons.light_mode,
                        () {
                          setState(() {
